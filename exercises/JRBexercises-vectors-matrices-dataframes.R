...
#Gender(character),Hand(character),Height(numeric),Unit(character),Age(numeric)
# b. Are there NAs in the data frame s? In which columns? How many?
#Yes, there are 28 NA's in the Height and HeightUnit columns.
# -------------------------------------------------------------------

# 4. Accessing data in the data frame 
#
# a. Run the function str() on the data frame s. What does it tell you?
#Factors and nums with different levels
...
test=c(!gIdx,!hIdx,!htIdx,!htUIdx,!aIdx,s)
